...
var texts = [
	...
	"Every night, I watch the river of stars spiraling in the heavens, then descending into the deep ocean.",
	...
	"But the solitary stargazer requires no company. We are all bound to the ocean of stars.",
	...
	"And now, Kether travels into the Ocean of Memories in which he has immersed himself. None can follow him.",
	"Inspired by the cosmos, its stellar brilliance is undying. Such courage illuminates the heavens with endless exploration.",
	"Youthful fabric adorned with diamond-like sleeves, reflecting a soul's strength and eternal devotion.",
	...
	"If this is a dream, please do not let me wake too soon!",
	...
	"Legend whispers that within the delicate and fragile butterfly form, there dwells also the power to summon hurricanes. This butterfly, woven of pure wind, undoubtedly awaits the day when another tempest is called forth.",
	...
	"I desire this shallow and unkind world to revolve around my happiness.",
	"The dusk fades into a rose gradient as stars appear, twinkling upon your dress.",
	"We must distort the fate of destruction through retribution, ascend into the chariot of revival, and bask in the luminescence of the craved wave.",
